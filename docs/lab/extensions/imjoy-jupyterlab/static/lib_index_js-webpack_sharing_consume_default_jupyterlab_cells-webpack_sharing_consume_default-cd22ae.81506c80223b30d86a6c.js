  ...
  handleState(
   ...
   addCell(doc, code) {
    ...
    setTimeout(async ()=>{
      ...
      try{
        const ret = await _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_5__.NotebookActions.runAndAdvance(this.notebook, this.sessionContext)
        console.log(ret)
      }
      catch(e){
        console.error(e)
    ...
    class ContentWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_2__.Widget {
      ...
      createNode() {
        ...
        this.executeButton.onclick = async () => {
          ...
          const prompt = [promptPrefix].concat(nbExt.getCodeHistory()).join('\n') + `\n${formatedCommand}\n`
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_jupyterlab_cells-webpack_sharing_consume_default-cd22ae.81506c80223b30d86a6c.js.map