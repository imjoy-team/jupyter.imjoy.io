"use strict";
(self["webpackChunkcodex_chat_notebook"] = self["webpackChunkcodex_chat_notebook"] || []).push([["lib_index_js-webpack_sharing_consume_default_jupyterlab_cells-webpack_sharing_consume_default-cd22ae"],{
...
/* harmony import */ var _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @jupyterlab/notebook/lib/actions */ "./node_modules/@jupyterlab/notebook/lib/actions.js");
  ...
  handleState(
   ...
   addCell(doc, code) {
    ...
    setTimeout(async ()=>{
      ...
      try{
        const ret = await _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_6__.NotebookActions.run(this.notebook, this.notebook.context.sessionContext)
        console.log(ret)
      }
      catch(e){
        console.error(e)
   ...
   runCell(){
    ...
    _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_6__.NotebookActions.run(this.notebook, this.notebook.context.sessionContext)
   }

   runAllCells(){
    _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_6__.NotebookActions.runAll(this.notebook, this.notebook.context.sessionContext)
   }
   ...
   undoCell(){
     ...
     if(this.notebook.lastCellNumber && this.notebook.lastCellNumber > 0){
       for(let i=0;i<this.notebook.lastCellNumber;i++){
        ...
        _jupyterlab_notebook_lib_actions__WEBPACK_IMPORTED_MODULE_6__.NotebookActions.cut(this.notebook)
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_jupyterlab_cells-webpack_sharing_consume_default-cd22ae.c0e0b4b3734e6f5f4680.js.map